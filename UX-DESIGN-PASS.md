...
- [~] Phase 3 — **axis workbench 3a** ✅ (data-derived selectable axes: annotations · connections · recency · body length · # themes; click-to-open, filter-aware) · [ ] 3b manual placement (needs a per-card axis-value column) · [ ] tag-overlap affinity
