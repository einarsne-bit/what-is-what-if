...
- [~] Phase 3 — **axis workbench 3a** ✅ (selectable axes: measures — annotations · connections · recency · body length · # themes — OR a **theme on each axis for a 2×2 quadrant** surfacing cross-theme bridges; jittered, filter-aware, click-to-open) · [ ] 3b manual placement (needs a per-card axis-value column) · [ ] tag-overlap affinity
